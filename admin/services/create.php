    ...
    <div class="container">
        ...
        <div class="employees col-9">
            <div class="button row">
                ...
                <a href="index.php" class="col-3 btn btn-warning">Manage Service</a>
            </div>
            ...
            <div class="row add-employee">
                <form action="create.php" method="post" enctype="multipart/form-data">
                    <div class="col mb-3">
                        <input name="service_name" value="<?= $service_name; ?>" type="text" class="form-control"
                    ...
                    <div class="col mb-5">
                        <input name="duration" type="text" class="form-control" placeholder="Duration"
                               aria-label="Duration" value="<?= $duration ?>">
                    </div>
                    <div class="form-group mb-3">
                        <label for="exampleFormControlTextarea1">Service Benefits</label>
                        <textarea name="benefits" class="form-control" id="exampleFormControlTextarea1"
                                  rows="3"><?= $benefits ?></textarea>
                    </div>
                    ...
                    <div class="col">
                        <button name="btn-save" class="btn btn-primary" style="width: 9rem" type="submit">Save</button>
                    </div>
                </form>
            </div>
        </div>
